    ...
    for epoch in range(15):                  # 本来是10
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            for ep_idx in range(epochs_ppo):
                ...
                tour_indices, tour_logp, mask, all_logp = actor(static,weight, tour_indices, mask, old_tour_logp, advantage)  ###
                #if ep_idx <=1:
                #    print(tour_logp[0])

                tour_logp = all_logp.gather(2,tour_indices.unsqueeze(-1))  # [batch_size, num_nodes]
