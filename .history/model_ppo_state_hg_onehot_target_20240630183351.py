...
class DRL4TP(nn.Module):
    ...
    def forward(self, static,weight, last_hh=None, actions=None):  ###
        ...
        tour_idx, tour_logp = [], []
        max_steps = sequence_size -1 # 第一个点是默认的    
        ...
        for step_idx in range(max_steps):
            ...
            probs, last_hh = self.pointer(node_embedding,state_embedding, decoder_hidden, target_hidden, last_hh)
        ...
        return tour_idx, tour_logp, mask, torch.stack(all_probs,dim=1)  ## all_probs [batch_size, num_nodes-1, num_nodes-1]
